...
public class SendNotificationToAdminHandler extends BaseUserNotificationHandler{
	private static final Log _log = LogFactoryUtil.getLog(SendNotificationToAdminHandler.class);

	public static final String PORTLET_ID= "com_cafeteria_CafeteriaAdminLivePortlet";

	    public SendNotificationToAdminHandler() {
